...
end_time = time.time()
print(
    f"Data processing result (First call): {result_1}, Time taken: {end_time - start_time:.6f} seconds")
...
end_time = time.time()
print(
    f"Data processing result (Second call with caching): {result_2}, Time taken: {end_time - start_time:.6f} seconds")
